...
REM
REM Generated by Vivado on Fri Sep 15 00:22:33 +0530 2023
...
echo "xvlog --incr --relax -prj SOPMUX_test_vlog.prj"
call xvlog  --incr --relax -prj SOPMUX_test_vlog.prj -log xvlog.log
