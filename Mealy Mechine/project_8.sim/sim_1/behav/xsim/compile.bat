...
REM
REM Generated by Vivado on Mon Dec 04 16:27:01 +0530 2023
...
echo "xvlog --incr --relax -prj Mealy_test_vlog.prj"
call xvlog  --incr --relax -prj Mealy_test_vlog.prj -log xvlog.log
