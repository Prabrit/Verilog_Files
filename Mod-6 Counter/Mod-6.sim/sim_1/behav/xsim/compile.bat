...
REM
REM Generated by Vivado on Tue Nov 28 09:46:16 +0530 2023
...
echo "xvlog --incr --relax -prj Mod_ten_test_vlog.prj"
call xvlog  --incr --relax -prj Mod_ten_test_vlog.prj -log xvlog.log
