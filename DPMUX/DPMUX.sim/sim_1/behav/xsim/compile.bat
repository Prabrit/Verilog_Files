...
REM
REM Generated by Vivado on Sun Sep 24 02:18:16 +0530 2023
...
echo "xvlog --incr --relax -prj two_to_one_test_vlog.prj"
call xvlog  --incr --relax -prj two_to_one_test_vlog.prj -log xvlog.log
