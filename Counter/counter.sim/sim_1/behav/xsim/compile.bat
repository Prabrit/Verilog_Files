...
REM
REM Generated by Vivado on Tue Nov 28 09:28:27 +0530 2023
...
echo "xvlog --incr --relax -prj ModuloCounter_vlog.prj"
call xvlog  --incr --relax -prj ModuloCounter_vlog.prj -log xvlog.log
