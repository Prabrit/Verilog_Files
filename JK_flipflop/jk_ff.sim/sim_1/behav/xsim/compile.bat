...
REM
REM Generated by Vivado on Sun Nov 05 11:21:30 +0530 2023
...
echo "xvlog --incr --relax -prj jkff_test_vlog.prj"
call xvlog  --incr --relax -prj jkff_test_vlog.prj -log xvlog.log
