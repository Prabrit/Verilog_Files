...
REM
REM Generated by Vivado on Wed Sep 13 09:47:00 +0530 2023
...
echo "xvlog --incr --relax -prj DecoderSOP_tb_vlog.prj"
call xvlog  --incr --relax -prj DecoderSOP_tb_vlog.prj -log xvlog.log
