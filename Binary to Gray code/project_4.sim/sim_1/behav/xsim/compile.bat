...
REM
REM Generated by Vivado on Thu Sep 14 19:56:07 +0530 2023
...
echo "xvlog --incr --relax -prj Graycode_tb_vlog.prj"
call xvlog  --incr --relax -prj Graycode_tb_vlog.prj -log xvlog.log
