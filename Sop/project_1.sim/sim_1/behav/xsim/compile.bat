...
REM
REM Generated by Vivado on Sat Sep 02 23:41:50 +0530 2023
...
echo "xvlog --incr --relax -prj SOP_tb_vlog.prj"
call xvlog  --incr --relax -prj SOP_tb_vlog.prj -log xvlog.log
